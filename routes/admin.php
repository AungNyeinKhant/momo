...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('supplier/add-new', 'SupplierController@addNew')->name('supplier.addNew');
        ...
        Route::group(['prefix' => 'food', 'as' => 'food.', 'middleware' => ['module:food']], function () {
            ...
            Route::get('feature/{id}/{feature}', 'FoodController@feature')->name('feature');
        ...
        Route::group(['prefix' => 'banner', 'as' => 'banner.', 'middleware' => ['module:banner']], function () {
            ...
            Route::get('popup-banner', 'BannerController@popup_banner')->name('popup_banner');
            Route::post('popup-banner-update', 'BannerController@popup_banner_update')->name('popup_banner_update');
        });
