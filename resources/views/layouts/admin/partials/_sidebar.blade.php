            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('banner'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/banner/popup-banner*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.banner.popup_banner') }}"
                                title=" Popup Banner ">
                                <i class="tio-tabs nav-icon side-nav-icon--design"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.popup_banner') }}</span>
                            </a>
                        </li>
                    @endif
                    <!-- End Banner -->
                ...
                <!-- End Restaurant -->
                 ...
                 <li class="nav-item">
                    <small class="nav-subtitle"
                            title="{{translate('messages.Kitchen')}} {{translate('messages.section')}}">{{translate('messages.Kictchen')}} {{translate('messages.management')}}</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>

                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('Items')}}"
                    >
                        <i class="tio-premium-outlined nav-icon"></i>
                        <span
                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('messages.Supplier')}}</span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('admin.supplier.addNew') }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{route('admin.supplier.list')}}"  title="{{translate('Supplier List')}}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{translate('messages.list')}}</span>
                            </a>
                        </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link " href="{{route('admin.supplier.list')}}"  title="{{translate('Food List')}}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{translate('messages.buying')}} {{translate('messages.items')}}</span>
                            </a>
                        </li> --}}
                    </ul>
                </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            title="{{ translate('messages.restaurant_withdraw_method') }}">
                            <i class="tio-savings nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.restaurant_withdraw_method') }}</span>
                        </a>
                        </li>
                    @endif
                    <!-- End withdraw -->
