                        ...
                        <div class="row">
                            <div class="col-12">
                                <center>
                                    ...
                                    <hr>
                                    <button onclick="check_order()" class="btn btn-primary">{{translate('messages.Ok_let_me_check')}}</button>
                                </center>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <center>
                                    ...
                                    <button onclick="check_message()"
                                        class="btn btn-primary">{{ translate('messages.Ok_let_me_check') }}</button>
                                </center>
                            </div>
                        </div>
                    </div>
   ...
   <script>
    ...
    <audio id="myAudio">
        {{-- <source src="{{ asset('public/assets/admin/sound/notification.mp3') }}" type="audio/mpeg"> --}}
            <source src="{{asset('public/assets/admin/sound/freshbitesxpress.mp3')}}" type="audio/mpeg">
    </audio>
    ...
    // ANK Move get-restaurant-data from here
