...
<html dir="{{ $site_direction }}" lang="{{ str_replace('_', '-', app()->getLocale()) }}"  class="{{ $site_direction === 'rtl'?'active':'' }}"><head>
    ...
    <script src="{{asset('public/assets/admin')}}/vendor/qrcode.js"></script>
    <script src="{{asset('public/assets/admin')}}/vendor/jquery/jquery.min.js"> // qrcode generate link</script> 
</head>
