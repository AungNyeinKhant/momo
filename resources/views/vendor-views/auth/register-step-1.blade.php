                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="form-group mb-0">
                                ...
                                <select name="restaurantType">
                                    <option value="" selected disabled>Please Choose Restaurant type</option>
                                    <option value="Big Restaurant">Big Restaurant</option>
                                    <option value="Home Restaurant">Home Restaurant</option>
                                    <option value="Street Shop">Street Shop</option>
                                </select>
                            </div>
                        </div>
