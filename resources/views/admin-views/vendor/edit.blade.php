                    ...
                    <div class="card shadow--card-2">
                        <div class="card-body">
                            ...
                            <div class=" lang_form" >
                                ...
                                <div class="form-group" >
                                    <label class="input-label" for="exampleFormControlInput1">Please Select Restaurant Type</label>
                                    <select class="form-control" name="restaurantType">
                                        <option <?php if($restaurant->restaurant_type == "Street Shop"){ echo "selected"; } ?> value="Street Shop">Street Shop</option>
                                        <option <?php if($restaurant->restaurant_type == "Home Restaurant"){ echo "selected"; } ?> value="Home Restaurant">Home Restaurant</option>
                                        <option <?php if($restaurant->restaurant_type == "Big Restaurant"){ echo "selected"; } ?> value="Big Restaurant">Big Restaurant</option>
                                    </select>
                                </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative">
                                        ...
                                        <input type="text" required id="time_view" value="{{$delivery_time_start}} to {{$delivery_time_end}} {{$delivery_time_type}}"  class="form-control" readonly>
