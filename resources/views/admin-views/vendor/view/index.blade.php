                                ...
                                <div class="resturant--info-address">
                                    ...
                                    <ul class="address-info list-unstyled list-unstyled-py-3 text-dark">
                                        <li>
                                            <h5 class="name">
                                                <!--{{$restaurant->name}}-->
                                                {{$restaurant->getRawOriginal('name')}}
                                            </h5>
                                        </li>
                                        <li>
                                            ...
                                            <span class="pl-1">
                                                ...
                                                {{translate('messages.address')}} : {{$restaurant->getRawOriginal('address')}}
                                            </span>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <span class="pl-1">
                                                ...
                                                {{translate('messages.phone')}} : {{$restaurant->getRawOriginal('phone')}}
                                            </span>
                                        </li>
                                        <li>
                                            ...
                                            <span class="pl-1">
                                                ...
                                                {{translate('messages.email')}} : {{$restaurant->getRawOriginal('email')}}
                                            </span>
                                        </li>
                                        <li>
                                            <i class="tio-city nav-icon"></i>
                                            <span class="pl-1">
                                                {{translate('messages.restaurant_type')}} : {{$restaurant->getRawOriginal('restaurant_type')}}
                                            </span>
                                        </li>
                                    </ul>
                                </div>
