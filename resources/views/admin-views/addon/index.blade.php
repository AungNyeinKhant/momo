...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{isset($addon)?route('admin.addon.update',[$addon['id']]):route('admin.addon.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @if($language)
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 ">
                            ...
                            <input type="file" name="image" class="form-control" placeholder="Image Insert Here" required maxlength="191">
                        </div>
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table"  data-hs-datatables-options='{
                        ...
                        <tr>
                            ...
                            <th class="text-center w-20p">Addon Image</th>
                        ...
                        @foreach($addons as $key=>$addon)
                            <tr>
                                ...
                                <span class="d-block font-size-sm text-body text-center">
                                    ...
                                    {{ $addon->getRawOriginal('name') }}
                                </span>
                                </td>
                                <td>
                                    <img class="img-fluid" src="{{asset('storage/app/public/Addon/')}}/{{$addon['image']}}" alt="Addon Image">
                                </td>
                                <td>
