                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="w-100px">{{ translate('messages.feature') }}</th>
                            ...
                            <tbody id="set-rows">
                                @foreach ($foods as $key => $food)
                                    <tr>
                                        ...
                                        <!--ANK Add Feature slot-->
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                for="stocksCheckbox{{ $food->id }}">
                                                <input type="checkbox"
                                                    onclick="location.href='{{ route('admin.food.feature', [$food['id'], $food->feature ? 0 : 1]) }}'"
                                                    class="toggle-switch-input" id="stocksCheckbox{{ $food->id }}"
                                                    {{ $food->feature ? 'checked' : '' }}>
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                        </td>
                                        <!--ANK Feature solt end-->
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                for="stocksCheckbox{{ $food->id }}">
                                                <input type="checkbox"
