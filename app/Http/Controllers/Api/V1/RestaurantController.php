...
class RestaurantController extends Controller
{
    public function get_restaurants(Request $request, $filter_data="all")
    {
        ...
        // big_restaurant:$request->big_restaurant,home_restaurant:$request->home_restaurant,street_shop:$request->street_shop,
        ...
        $restaurants = RestaurantLogic::get_restaurants(big_restaurant:$request->big_restaurant,home_restaurant:$request->home_restaurant,street_shop:$request->street_shop,zone_id:$zone_id, filter:$filter_data, limit:$request['limit'],offset: $request['offset'],type:$type, name:$name,longitude:$longitude,latitude:$latitude,cuisine:$cuisine ,veg:$request->veg ,non_veg:$request->non_veg, discount:$request->discount, top_rated:$request->top_rated  );
